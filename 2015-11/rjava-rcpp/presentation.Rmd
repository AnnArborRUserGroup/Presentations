...
**Wanted to Demonstrate Usefulness of rJava**

 - Please note: not a Java hater
 
 - And yes, its usually fast... if you are doing it right

 - Java is a language of reuse,  many complex, powerful libraries being reused daily
