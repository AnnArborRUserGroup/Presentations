...
search_artist <- spotifyr::search('dio',type = 'artist')
...
summarized_artists[1:2,c('name','id','genre','popularity')]
```
...
summarized_tracks <- ldply(top_tracks$tracks,data.frame)
summarized_tracks[1:2,c('artists.name','name','popularity','duration_ms','id')]
```

<iframe src="https://embed.spotify.com/?uri=spotify:track:6hUrzrmbteorudAVzv4x4A" width="330" height="250" frameborder="0" allowtransparency="true"></iframe>
...
- Create a music recommender Shiny app integrating [Gracenote](https://developer.gracenote.com/music-platforms) and [metal-archives](metal-archives.com) data with embedded Spotify player and playlist creater 
