...
- `%in%` - compound assignment pipe operator
...
```{r,eval=FALSE}
### <b>
eval(call(paste("func",as.character(i),as.character(alpha+1),sep=".")),(x*(1+f*odds)))
### </b>
```
...
## The combination of %>% with {dplyr}
 ...
 - `mutate()`
    - `iris$new.var <- iris$Sepal.Length * iris$Sepal.Width`
 - `select()`
