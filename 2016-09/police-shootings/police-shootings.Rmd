...
- Covers 2015+
- Under version-control on [https://github.com/washingtonpost/data-police-shootings](github)
...
- $\frac{\lambda_{Black}}{\lambda_{White}} = \frac{e^{\theta_{1}'x_1 + \theta_{2}'x}}{e^{\theta{2}'x}}$
- $\text(Relative Risk_{Black:White}) = e^{\theta{i}}$ for any $\theta_i$ coded to interact with race
...
# Conclusions
- Data wrangling is hard, but important
